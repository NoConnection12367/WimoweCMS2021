...
<html>
    ...
    <body>
        ...
        <div id="navigation">
            <ul>
                <li><i class="fas fa-search"></i><a href="#">Vorschau</a></li>
                <li><i class="far fa-file-alt"></i><a href="#">Seiten verwalten</a></li>
                <li><i class="far fa-images"></i><a href="#">Mediathek</a></li>
                <li><i class="fas fa-palette"></i><a href="#">Layout & Farben</a></li>
                <li><i class="fas fa-users-cog"></i><a href="#">Rechteverwaltung</a></li>
            </ul>
